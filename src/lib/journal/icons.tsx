...
export const CalendarCheckIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  className = ''
}) => (
...
export const SparklesIcon: React.FC<IconProps> = ({
  ...
  >
    ...
    <path d="M19 13l.8 2.9L23 17l-3.2 1.1L19 21l-.8-2.9L15 17l3.2-1.1L19 13z" />
    <path d="M3 13l.6 2.2L6 16l-2.4.8L3 19l-.6-2.2L0 16l2.4-.8L3 13z" />
  </svg>
);
