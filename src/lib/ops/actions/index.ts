...
export const ACTIONS_BY_CATEGORY: Record<Category, ActionItem[]> = {
  communication: [
    { id: 'decode-message', title: 'Understand & Respond', description: 'Decode messages and craft the right response', icon: 'message', placeholder: 'Paste the message you want to decode...', systemPrompt: 'Analyze this message and explain: 1) What they\'re actually saying (the subtext), 2) Their likely emotional state, 3) What they probably want from you, 4) Suggested response approach. Be direct and insightful.' },
  ],
