...
const ROOMS: Room[] = [
  { id: 'therapy', name: 'Therapy Room', essence: 'SPEAK FREELY', free: false },
  { id: 'zen', name: 'Zen Garden', essence: 'FIND STILLNESS', free: true },
  { id: 'library', name: 'Library', essence: 'DISCOVER WISDOM', free: true, note: '1 story free' },
  { id: 'rest', name: 'Rest Chamber', essence: 'EMBRACE SLEEP', free: false },
  { id: 'studio', name: 'Design Studio', essence: 'CREATE BEAUTY', free: false },
  { id: 'journal', name: 'Journal Nook', essence: 'REFLECT DEEPLY', free: true },
  { id: 'pulse', name: 'Pulse', essence: 'CONNECT WITH OTHERS', free: true, note: 'Community' },
];
...
export default function SanctuarySpace() {
  ...
  const [isSubscribed, setIsSubscribed] = useState(false); // TODO: Check actual subscription status
  ...
  return (
    <>
      ...
      <div className="sanctuary">
        {/* Back Button */}
        <a href="/sanctuary" className="back-btn">
          ← Back
        </a>
        ...
        <div className="greeting-area">
          ...
          <p className="greeting-sub">Your space awaits</p>
        </div>
        ...
        <div className="rooms">
          <div className="rooms-grid">
            {ROOMS.map((room) => (
              <div
                key={room.id}
                className={`room-card ${!room.free && !isSubscribed ? 'locked' : ''}`}
                onClick={() => handleRoomClick(room)}
              >
                {!room.free && !isSubscribed && <span className="lock-badge">🔒</span>}
        ...
        <div className="bottom-bar">
          <button className="talk-btn" onClick={() => router.push('/chat')}>
            Talk to VERA
          </button>
        </div>
      </div>
